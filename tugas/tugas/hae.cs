...
namespace tugas
{
    class hae
    {
        public void senin()
        {
            String[] x = { "1. Sistem digital pada pukul08.50-10.30", "2. Praktikum DKP pada pukul 18.00-18.50", "3. Konsep Jaringan Komputer pada pukul 20.00-21.40" };
        ...
        public void jumat()
        {
            String[] x = { "1. Etika Provesi pada jam 07.00-08,40", "2. Elektonika dasar pada jam 14.00-16.30", "3. Praktimu Fisika dasar pada pukul 18.00-18.50" };
            Console.WriteLine("Mata kuliah :");
            foreach (String y in x)
            {
                Console.WriteLine(y);
